export function getWelcomeEmailHtml(userName: string, planName: string): string {
    return `
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Bem-vindo à Eon Pro</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #e0e0e0;">
                                Estamos muito felizes em ter você conosco! Sua conta foi criada com sucesso na <strong style="color: #00d4aa;">Eon Pro</strong>, a plataforma de bots de trading mais avançada do mercado.
                            </p>

                            <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #e0e0e0;">
                                Você está inscrito no plano <strong style="color: #00d4aa;">${planName}</strong> e já pode começar a criar e executar seus bots de trading automatizados.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="https://app.iaeon.site" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #00d4aa 0%, #00a886 100%); color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 12px rgba(0, 212, 170, 0.3); transition: all 0.3s ease;">
                                            Acessar Plataforma →
                                        </a>
                                    </td>
                                </tr>
